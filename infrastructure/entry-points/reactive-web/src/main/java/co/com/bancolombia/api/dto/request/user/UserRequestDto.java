package co.com.bancolombia.api.dto.request.user;
...
public class UserRequestDto {
    ...
    @Pattern(regexp = "^\\d{6,12}$", message = "The document must contain between 6 and 12 digits")
    ...
    @Pattern(regexp = "^\\d{7,15}$", message = "The phone number must contain between 7 and 15 digits")
    ...
    @DecimalMax(value = "15000000.0", message = "The base salary must not exceed 15000000")
