    ...
    public SecurityWebFilterChain filterChain(ServerHttpSecurity http, JwtFilter jwtFilter) {
        return http
                ...
                .authorizeExchange(exchanges -> exchanges
                        .pathMatchers("/api/test-protected").authenticated()
                        .pathMatchers("/api/v1/login", "/swagger-ui/**", "/v3/api-docs/**", "/webjars/**", "/favicon.ico").permitAll()
                        .pathMatchers("/auth/**").permitAll()
                        .pathMatchers(HttpMethod.POST, "/api/v1/usuarios").hasAnyRole("ADMIN", "ADVISOR")
                        .pathMatchers(HttpMethod.GET, "/api/v1/usuarios/correo").hasAnyRole("ADMIN", "ADVISOR", "CUSTOMER")
